...
const PLUGIN_LIB_NANOS = { 'template': Resolve("elfs/plugin_nanos.elf") };
const PLUGIN_LIB_NANOX = { 'template': Resolve("elfs/plugin_nanox.elf") };
const PLUGIN_LIB_NANOSP = { 'template': Resolve("elfs/plugin_nanosp.elf") };
